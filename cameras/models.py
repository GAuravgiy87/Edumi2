...
class CameraRecording(models.Model):
    ...
    def generate_thumbnail(self, time_sec=1.0):
        ...
        if not self.video_file or not self.video_file.path or not os.path.exists(self.video_file.path):
            print("Video file not found, skipping thumbnail generation")
            return None
        ...
        try:
            ...
            print("FFmpeg not found, skipping thumbnail generation")
            return None
        except subprocess.TimeoutExpired:
            print("FFmpeg timed out, skipping thumbnail generation")
            return None
